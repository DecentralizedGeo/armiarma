...
type FilecoinCrawlerConfig struct {
...
// NewFilecoinCrawlerConfig returns a new FilecoinCrawlerConfig with default values
func NewFilecoinCrawlerConfig() *FilecoinCrawlerConfig {
	return &FilecoinCrawlerConfig{
		...
		Bootnodes:                 DefaultFilecoinBootnodes,
		PersistConnEvents:         DefaultPersistConnEvents,
	}
}

func (c *FilecoinCrawlerConfig) Apply(ctx *cli.Context) {
	...
	}).Info("config for the Filecoin crawler")
}

func (c *FilecoinCrawlerConfig) Network() utils.NetworkType {
