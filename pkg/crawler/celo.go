...
import (
	...
	"github.com/migalabs/armiarma/pkg/networks/celo"
...
// CeloCrawler is the crawler for Celo L2 network
type CeloCrawler struct {
	ctx       context.Context
...
func NewCeloCrawler(mainCtx *cli.Context, conf config.CeloCrawlerConfig) (*CeloCrawler, error) {
	...
	// Create a local Celo node
	celoNode := celo.NewLocalCeloNode()
	...
	// Create a new discovery4 service to discover peers in the Celo network
...
func (c *CeloCrawler) GetMetrics() *metrics.MetricsModule {
	metricsMod := metrics.NewMetricsModule(
		"crawler",
		"Celo Crawler metrics",
	)
...
func (c *CeloCrawler) clientDistributionMetrics() *metrics.IndvMetrics {
	initFn := func() error {
...
func (c *CeloCrawler) versionDistributionMetrics() *metrics.IndvMetrics {
	initFn := func() error {
...
func (c *CeloCrawler) geoDistributionMetrics() *metrics.IndvMetrics {
	initFn := func() error {
...
func (c *CeloCrawler) nodeDistributionMetrics() *metrics.IndvMetrics {
	initFn := func() error {
...
func (c *CeloCrawler) deprecatedNodeMetrics() *metrics.IndvMetrics {
	initFn := func() error {
...
func (c *CeloCrawler) getPeersOs() *metrics.IndvMetrics {
	initFn := func() error {
...
func (c *CeloCrawler) getPeersArch() *metrics.IndvMetrics {
	initFn := func() error {
...
func (c *CeloCrawler) getHostedPeers() *metrics.IndvMetrics {
	initFn := func() error {
...
func (c *CeloCrawler) getRTTDist() *metrics.IndvMetrics {
	initFn := func() error {
...
func (c *CeloCrawler) getIPDist() *metrics.IndvMetrics {
	initFn := func() error {
